...
ALTER TABLE `tabEmployee`
    DROP COLUMN IF EXISTS mobile_first_name,
    DROP COLUMN IF EXISTS mobile_middle_name,
    DROP COLUMN IF EXISTS mobile_last_name,
    DROP COLUMN IF EXISTS mobile_date_hired,
    DROP COLUMN IF EXISTS mobile_date_of_birth,
    DROP COLUMN IF EXISTS mobile_gender,
    DROP COLUMN IF EXISTS mobile_nationality,
    DROP COLUMN IF EXISTS mobile_marital_status,
    DROP COLUMN IF EXISTS mobile_department,
    DROP COLUMN IF EXISTS mobile_immediate_superior,
    DROP COLUMN IF EXISTS manager_2,
    DROP COLUMN IF EXISTS mobile_department_head,
    DROP COLUMN IF EXISTS mobile_sss,
    DROP COLUMN IF EXISTS mobile_tin,
    DROP COLUMN IF EXISTS mobile_philhealth,
    DROP COLUMN IF EXISTS mobile_pagibig,
    DROP COLUMN IF EXISTS region,
    DROP COLUMN IF EXISTS mobile_branch,
    DROP COLUMN IF EXISTS mobile_employee_code,
    DROP COLUMN IF EXISTS mobile_contact_no,
    DROP COLUMN IF EXISTS mobile_company_email,
    DROP COLUMN IF EXISTS mobile_personal_email,
    DROP COLUMN IF EXISTS mobile_perm_add,
    DROP COLUMN IF EXISTS mobile_home_add,
    DROP COLUMN IF EXISTS mobile_present_add,
    DROP COLUMN IF EXISTS emergency_contact_no,
    DROP COLUMN IF EXISTS ftap_nationality,
    DROP COLUMN IF EXISTS ftap_age,
    DROP COLUMN IF EXISTS ftap_marital_status,
    DROP COLUMN IF EXISTS ftap_tin_number,
    DROP COLUMN IF EXISTS ftap_sss_number,
    DROP COLUMN IF EXISTS ftap_pagibig_number,
    DROP COLUMN IF EXISTS ftap_philhealth_number,
    DROP COLUMN IF EXISTS ftap_immediate_superior,
    DROP COLUMN IF EXISTS immediate_email,
    DROP COLUMN IF EXISTS ftap_position_classification,
    DROP COLUMN IF EXISTS ftap_department_head,
    DROP COLUMN IF EXISTS manager_,
    DROP COLUMN IF EXISTS ftap_hiring_date,
    DROP COLUMN IF EXISTS ftap_date_of_regularization,
    DROP COLUMN IF EXISTS ftap_region,
    DROP COLUMN IF EXISTS dh_email,
    DROP COLUMN IF EXISTS manager_plus_email,
    DROP COLUMN IF EXISTS ftap_license_certification,
    DROP COLUMN IF EXISTS ftap_payroll_account_branch,
    DROP COLUMN IF EXISTS ftap_height,
    DROP COLUMN IF EXISTS ftap_weight,
    DROP COLUMN IF EXISTS ftap_avega_member_number,
    DROP COLUMN IF EXISTS ftap_passport_number,
    DROP COLUMN IF EXISTS ftap_date_issue,
    DROP COLUMN IF EXISTS ftap_place_of_issue,
    DROP COLUMN IF EXISTS ftap_copy_of_passport,
    DROP COLUMN IF EXISTS ftap_valid_upto,
    DROP COLUMN IF EXISTS ftap_special_needs,
    DROP COLUMN IF EXISTS last_reporting_date,
    DROP COLUMN IF EXISTS ftap_separation_date,
    DROP COLUMN IF EXISTS ftap_reason_for_leaving,
